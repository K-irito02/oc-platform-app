...
public class JsonbLongMapTypeHandler extends BaseTypeHandler<Map<String, Long>> {

    private static final ObjectMapper MAPPER = new ObjectMapper();

    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, Map<String, Long> parameter, JdbcType jdbcType) throws SQLException {
    ...
    private Map<String, Long> parseJson(String json) throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Error parsing JSONB to Map<String, Long>", e);
        }
    }
}
